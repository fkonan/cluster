<?php use Core\FH; ?>
<form method="post" action="" id="frmResiduoClase" role="form">
	<div class="row">
		<?= FH::inputBlock('hidden','Id','id',$this->datos->id,['class'=>'form-control'],['class'=>'form-group col-md-12 d-none'],[]) ?>
		<?= FH::inputBlock('text','Nombre la clase del residuo','clase',$this->datos->clase,['class'=>'form-control'],['class'=>'form-group col-md-12'],[]) ?>
	</div>
