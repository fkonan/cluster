<?php use Core\FH; ?>
<form method="post" action="" id="frmTipoEmpresa" role="form">
	<?= FH::displayErrors($this->displayErrors) ?>
	<?= FH::csrfInput() ?>
	<div class="row">
		<?= FH::inputBlock('hidden','Id','id',$this->datos->id,['class'=>'form-control'],['class'=>'form-group col-md-12 d-none'],$this->displayErrors) ?>
		<?= FH::inputBlock('text','Tipo de empresa','tipo_empresa',$this->datos->tipo_empresa,['class'=>'form-control'],['class'=>'form-group col-md-12'],$this->displayErrors) ?>
	</div>
