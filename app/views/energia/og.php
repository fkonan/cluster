<?php $this->setSiteTitle('Energia - Linea Base - Oficinas Grandes')?>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="<?=PROOT?>img/modulos/energia/eneOG1.png" alt="Energia Oficinas Grandes Mod. 1">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?=PROOT?>img/modulos/energia/eneOG2.png" alt="Energia Oficinas Grandes Mod. 2">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?=PROOT?>img/modulos/energia/eneOG3.png" alt="Energia Oficinas Grandes Mod. 3">
    </div>
	<div class="carousel-item">
      <img class="d-block w-100" src="<?=PROOT?>img/modulos/energia/eneOG4.png" alt="Energia Oficinas Grandes Mod. 3">
    </div>
	<div class="carousel-item">
      <img class="d-block w-100" src="<?=PROOT?>img/modulos/energia/eneOGHVAC.png" alt="Energia Oficinas Grandes Mod. 3">
    </div>
	<div class="carousel-item">
      <!-- <img class="d-block w-100" src="<?=PROOT?>img/modulos/energia/usoHVACOG.png" alt="Energia Oficinas Grandes Mod. 4"> -->
