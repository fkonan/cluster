<?php $this->setSiteTitle('Arquitectura - Linea Base - E 3 Y 4')?>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="<?=PROOT?>img/modulos/arquitectura/arq3y41.png" alt="Arquitectura E 3 Y 4 Mod. 1">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?=PROOT?>img/modulos/arquitectura/arq3y42.png" alt="Arquitectura E 3 Y 4 Mod. 2">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?=PROOT?>img/modulos/arquitectura/arq3y43.png" alt="Arquitectura E 3 Y 4 Mod. 3">
    </div>
	<div class="carousel-item">
      <img class="d-block w-100" src="<?=PROOT?>img/modulos/arquitectura/arq3y44.png" alt="Arquitectura E 3 Y 4 Mod. 4">
    </div>
	<div class="carousel-item">
     <!-- <img class="d-block w-100" src="<?=PROOT?>img/modulos/arquitectura/ocupacion3y4.png" alt="Arquitectura E 3 Y 4 Ocupación De Vivienda"> -->
