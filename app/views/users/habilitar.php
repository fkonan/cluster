...
<div class="card border-primary">
   <div class="card-header text-center blue-bg text-white">
      <h3>Listado de usuario por habilitar</h3>
   </div>
   <div class="card-body">
   ...
   function format ( d ) {
      ...
      if(d.empresa_id!=null)
         {return '<div class="col-md-12 text-left blue-bg rounded"><p>Empresa: '+d.razon_social+'</p>'+
                     ...
                     '<p>Teléfono: '+d.telefono_fijo+'</p></div>'
                     '<p>Teléfono: '+d.telefono_fijo+'</p></div>'
                     '<p>Teléfono: '+d.telefono_fijo+'</p></div>'
                  ;}
      else{
         return '<p class="font-weight-bold">No hay datos de empresa porque es persona natural</p>';
      }
   }
