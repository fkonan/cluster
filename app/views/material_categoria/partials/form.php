<?php use Core\FH; ?>
<form method="post" action="" id="frmMaterialCategoria" role="form">
	<div class="row">
		<?= FH::inputBlock('hidden','Id','id',$this->datos->id,['class'=>'form-control'],['class'=>'form-group col-md-12 d-none'],[]) ?>
		<?= FH::inputBlock('text','Nombre de la categoria del material','categoria',$this->datos->categoria,['class'=>'form-control'],['class'=>'form-group col-md-12'],[]) ?>
	</div>
